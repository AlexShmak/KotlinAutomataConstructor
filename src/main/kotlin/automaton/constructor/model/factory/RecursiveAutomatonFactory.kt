...
class RecursiveAutomatonFactory : AbstractAutomatonFactory(RecursiveAutomaton.DISPLAY_NAME) {
            ...
            addTransition(
                ...
                throw AutomatonCreationFailedException(
                    MessageFormat.format(
                        I18N.messages.getString("RecursiveAutomatonFactory.FailedToParseRegex"),
    ...
    override fun createSettings() = listOf(
        Setting(
            displayName = I18N.messages.getString("RecursiveAutomatonFactory.FromRegex"),
            editor = TextField().apply {
                regexProperty.bind(textProperty())
                promptText = I18N.messages.getString("RecursiveAutomatonFactory.RegexExample")
            }
        )
    )
}